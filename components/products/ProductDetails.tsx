...
export default function ProductDetails(props) {
    ...
    return (
        ...
        <div >
            <div className="md:justify-between md:flex">
                <div className="">
                    <div className='font-serif '>
                        <img className='object-cover h-full mt-3 rounded-lg shadow-md md:h-56 lg:h-72' src={product.image} alt="meals/drinks image" />
                    </div>
                    <div className="px-2 mt-2">
                        <PropertyBox propertys={product.property} />
                    </div>
                </div>
                <div className="md:flex-1 md:ml-4 md:leading-7">
            ...
            <h3 className='mt-3 font-semibold text-gray-900 text-md sm:text-'>Ingredients:</h3>
            <div>
                {
                    product.ingredients.map((ingredient) => (
